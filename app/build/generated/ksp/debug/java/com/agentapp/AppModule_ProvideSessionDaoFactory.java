...
public final class AppModule_ProvideSessionDaoFactory implements Factory<SessionDao> {
  ...
  public AppModule_ProvideSessionDaoFactory(Provider<AgentDatabase> dbProvider) {
  ...
  public static AppModule_ProvideSessionDaoFactory create(Provider<AgentDatabase> dbProvider) {
    return new AppModule_ProvideSessionDaoFactory(dbProvider);
  }

  public static SessionDao provideSessionDao(AgentDatabase db) {
